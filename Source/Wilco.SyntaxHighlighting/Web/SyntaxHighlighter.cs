...
namespace Wilco.Web.SyntaxHighlighting
{
    ...
    public partial class SyntaxHighlighter : WebControl
    {
        ...
        /// <summary>
        /// Line number of the first shown code line
        /// </summary>
        public string StartLineNumber
        {
            get { return _StartLineNumber.ToString(); }
            set
            {
                string val = value ?? string.Empty;
                _StartLineNumber = (val != string.Empty) ? Convert.ToInt32(val) : 0;
            }
        }

        /// <summary>
        /// Line number of the last shown code line
        /// </summary>
        public string EndLineNumber
        {
            get { return _EndLineNumber.ToString(); }
            set
            {
                string val = value ?? string.Empty;
                _EndLineNumber = (val != string.Empty) ? Convert.ToInt32(val) : int.MaxValue;
            }
        }

        private int _StartLineNumber = 0;
        private int _EndLineNumber = int.MaxValue;

        private string _FunctionName = string.Empty;
        /// <summary>
        /// name of the function which will be highlighted
        /// </summary>
        public string FunctionName
        {
            get { return _FunctionName; }
            set { _FunctionName = value ?? string.Empty; }
        }
